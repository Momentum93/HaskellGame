...
/* package Util-0.1.0.0 */
#ifndef VERSION_Util
#define VERSION_Util "0.1.0.0"
#endif /* VERSION_Util */
#ifndef MIN_VERSION_Util
#define MIN_VERSION_Util(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Util */
...
#define CURRENT_COMPONENT_ID "Util-0.1.0.0-inplace-Util"
